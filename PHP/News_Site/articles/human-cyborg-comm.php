...
<body>
	...
	<h2 class="text-center">Meet C-3PO from Human-Cyborg Relations</h2>

	<div class="border border-info border-4 rounded">
		...
		<section class="community-discussions">
			...
			<!-- Reuse submit comment form  -->
			<?php include ('../includes/submit-comments.php') ?>
